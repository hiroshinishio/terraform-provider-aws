...
func (expander autoExpander) convert(ctx context.Context, sourcePath path.Path, valFrom reflect.Value, targetPath path.Path, vTo reflect.Value, legacy bool) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	case basetypes.Int64Valuable:
		diags.Append(expander.int64(ctx, vFrom, vTo, legacy)...)
		return diags
	...
	case basetypes.StringValuable:
		diags.Append(expander.string(ctx, vFrom, vTo, legacy)...)
		return diags
...
func (expander autoExpander) int64(ctx context.Context, vFrom basetypes.Int64Valuable, vTo reflect.Value, legacy bool) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (expander autoExpander) string(ctx context.Context, vFrom basetypes.StringValuable, vTo reflect.Value, legacy bool) diag.Diagnostics {
	var diags diag.Diagnostics
